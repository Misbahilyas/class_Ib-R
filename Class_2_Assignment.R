...
base_dir <- "C:/AI_Omics_Internship_2025"
...
# Step 10: Save final RData file
save(data, summary_list, file = "MisbahIlyas_Class_2_Assignment.RData")
cat("\nAll data and summaries saved in RData file.\n")
